 ...
 * The Ajax call will fetch a simple randomly generated name array from the backend and display it onto the screen.
 * The display logic is written using Vue.js 2.
 *
...
/**
 * Ajax Code That will return a array of random names.
 */
